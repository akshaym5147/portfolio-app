    ...
    <section className="border-b border-line/60 bg-paper/40" id="contact">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28 grid md:grid-cols-12 gap-10 md:gap-14">
        <div className="md:col-span-5">
          ...
          <p className="mt-5 text-inkSoft text-[16.5px] leading-relaxed max-w-md">
          ...
          <div className="mt-10 space-y-4">
            ...
            >
              ...
              <div>
                <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-inkSoft">
                  email
                </div>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            {profile.socials.map((s) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 font-mono text-[11.5px] uppercase tracking-[0.16em] border border-line rounded-full px-3.5 py-2 bg-cream text-inkSoft hover:border-amber hover:text-amber transition-colors"
              >
                {s.label}
        ...
        >
          ...
          <div className="mt-5">
            <Label htmlFor="subject" className="font-mono text-[11px] uppercase tracking-wider text-inkSoft">
              subject
            </Label>
            <Input
              id="subject"
