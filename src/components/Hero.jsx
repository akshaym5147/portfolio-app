...
const Hero = () => {
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 md:px-10 pt-16 md:pt-24 pb-20 md:pb-28 grid md:grid-cols-12 gap-10 md:gap-14 items-end">
        {/* Left — copy */}
        <div className="md:col-span-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-mono text-[12px] uppercase tracking-[0.16em] text-inkSoft">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3">
            <Button
              asChild
              className="bg-ink text-cream hover:bg-amber rounded-full px-6 h-12 font-mono text-[12px] tracking-wide"
            >
              <a href="#projects">
                see my work
            ...
            <Button
              asChild
              variant="outline"
              className="border-ink/80 text-ink hover:bg-ink hover:text-cream rounded-full px-6 h-12 font-mono text-[12px] tracking-wide bg-transparent"
            >
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3 font-mono text-[12px] text-inkSoft">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            {profile.stats.map((s) => (
              ...
              >
                ...
                <div className="font-mono text-[11px] uppercase tracking-wider text-inkSoft mt-0.5">
                  {s.label}
                </div>
              </div>
            ))}
      ...
      <div className="border-t border-line/60 bg-paper/60 overflow-hidden">
        <div className="flex marquee-track whitespace-nowrap py-4 font-mono text-[12px] uppercase tracking-[0.22em] text-inkSoft">
